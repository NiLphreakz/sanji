...
mkdir /root/.acme.sh
curl https://raw.githubusercontent.com/NiLphreakz/sanji/main/acme.sh -o /root/.acme.sh/acme.sh
...
wget -O certv2ray "https://raw.githubusercontent.com/${GitUser}/sanji/main/cert.sh"
