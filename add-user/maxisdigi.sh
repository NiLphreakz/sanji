...
patchtls=/nilphreakz-vmesswstls
patchnontls=/nilphreakz-vmesswsntls
...
patchtls=/nilphreakz-vlesswstls
patchnontls=/nilphreakz-vlesswsntls
uuid=$(cat /proc/sys/kernel/random/uuid)
read -p "   Bug Address (Example: www.google.com) : " address
read -p "   Bug SNI/Host (Example : m.facebook.com) : " sni
read -p "   Expired (days) : " masaaktif
...
patchtls=/nilphreakz-trojanwstls
patchnone=/nilphreakz-trojanwsntls
read -p "   Bug Address (Example: www.google.com) : " address
